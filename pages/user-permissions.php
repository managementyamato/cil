...
$defaultPagePermissions = [
    ...
    'manuals.php' => ['view' => 'sales', 'edit' => 'product'],
    'sales-tools.php' => ['view' => 'sales', 'edit' => 'sales'],
    'sales-tools.php#products'  => ['view' => 'sales', 'edit' => 'sales'],
    'sales-tools.php#customers' => ['view' => 'sales', 'edit' => 'product'],
    'sales-tools.php#catalogs'  => ['view' => 'sales', 'edit' => 'sales'],
    'sales-tools.php#scripts'   => ['view' => 'sales', 'edit' => 'sales'],
    'sales-tools.php#history'   => ['view' => 'sales', 'edit' => 'sales'],
    'sales-tools.php#leads'     => ['view' => 'sales', 'edit' => 'sales'],
    'sales-tools.php#create'    => ['view' => 'sales', 'edit' => 'sales'],
    ...
    'master-hub.php#masters'   => ['view' => 'product', 'edit' => 'product'],
    'master-hub.php#price'     => ['view' => 'admin',   'edit' => 'admin'],
    'master-hub.php#price-list'=> ['view' => 'sales',   'edit' => 'admin'],
    'master-hub.php#products'  => ['view' => 'admin',   'edit' => 'admin'],
    'master-hub.php#links'     => ['view' => 'admin',   'edit' => 'admin'],
    'master-hub.php#devices'   => ['view' => 'admin',   'edit' => 'admin'],
...
$pageLabels = [
    ...
    'sales-tools.php#products'  => '　└ 製品別（タブ）',
    'sales-tools.php#customers' => '　└ アカウントマネジメント（タブ）',
    'sales-tools.php#catalogs'  => '　└ カタログ（タブ）',
    'sales-tools.php#scripts'   => '　└ トークスクリプト（タブ）',
    'sales-tools.php#history'   => '　└ 見積履歴（タブ）',
    'sales-tools.php#leads'     => '　└ リード管理（タブ）',
    'sales-tools.php#create'    => '　└ 見積作成（タブ）',
    'settings.php' => '設定',
    'reports-hub.php' => '申請・報告',
    'reports-hub.php#report'   => '　└ 週報（タブ）',
    'reports-hub.php#approval' => '　└ 値引き申請（タブ）',
    'reports-hub.php#lead'     => '　└ リード管理（タブ）',
    'master-hub.php#masters'   => 'マスタ：マスタ管理（タブ）',
    'master-hub.php#price'     => 'マスタ：価格表マスタ・旧（タブ）',
    'master-hub.php#price-list'=> 'マスタ：価格表 v2（タブ・閲覧=営業 / 編集=管理部）',
    'master-hub.php#products'  => 'マスタ：製品マスタ（タブ）',
    'master-hub.php#links'     => 'マスタ：外部リンク（タブ）',
    'master-hub.php#devices'   => 'マスタ：デバイス管理（タブ）',
    'price-list.php'           => '価格表 v2（直接アクセス）',
