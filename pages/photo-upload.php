    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="instructions">
                <h4>使い方</h4>
                <ul>
                    <li>勤務中に車を使用する場合：アルコールチェック写真を1日2回アップロードしてください</li>
                    <li>勤務中に車を使用しない場合：下の「通勤時車使用していない」を選択してください</li>
                    <li>1回目・2回目は自動で判別されます（アップロード順に1回目→2回目）</li>
                    <li>鮮明な写真をアップロードしてください</li>
                        ...
                        <div style="display: flex; gap: 2rem; justify-content: center;">
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <?php if ($startUploaded): ?>
                                    <span style="color: var(--success-color); font-weight: bold; font-size: 1.25rem;">✓</span>
                                    <span style="color: var(--success-color); font-weight: 600;">1回目 済</span>
                                <?php else: ?>
                                    <span style="color: #cbd5e1; font-weight: bold; font-size: 1.25rem;">○</span>
                                    <span style="color: #64748b;">1回目 未</span>
                                <?php endif; ?>
                            </div>
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <?php if ($endUploaded): ?>
                                    <span style="color: var(--success-color); font-weight: bold; font-size: 1.25rem;">✓</span>
                                    <span style="color: var(--success-color); font-weight: 600;">2回目 済</span>
                                <?php else: ?>
                                    <span style="color: #cbd5e1; font-weight: bold; font-size: 1.25rem;">○</span>
                                    <span style="color: #64748b;">2回目 未</span>
                                <?php endif; ?>
                            </div>
                        </div>
