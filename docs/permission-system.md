...
| トラブル対応（troubles.php） | 営業部以上 | 製品技術部以上 |
| プロジェクト管理（master.php） | 製品技術部以上 | 製品技術部以上 |
| 損益（finance.php） | 製品技術部以上 | 製品技術部以上 |
| 借入金（loans.php） | 製品技術部以上 | 製品技術部以上 |
| 給与仕訳（payroll-journal.php） | 製品技術部以上 | 製品技術部以上 |
| アルコールチェック（photo-attendance.php） | 製品技術部以上 | 製品技術部以上 |
| マスタ管理（masters.php） | 製品技術部以上 | 製品技術部以上 |
