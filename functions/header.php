    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar">
            <nav class="sidebar-nav">
                ...
                <?php endif; ?>
                <a href="/pages/photo-upload.php" class="sidebar-link <?= basename($_SERVER['PHP_SELF']) == 'photo-upload.php' ? 'active' : '' ?>">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
                    <span>アルコールチェック写真</span>
                </a>
                <?php if (isAdmin()): ?>
                <a href="/pages/settings.php" class="sidebar-link <?= in_array(basename($_SERVER['PHP_SELF']), ['settings.php', 'mf-settings.php', 'mf-debug.php', 'mf-sync-settings.php', 'notification-settings.php', 'employees.php', 'users.php', 'integration-settings.php']) ? 'active' : '' ?>">
